...
public class AwsSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            createSecurityGroupRequest.withGroupName("java5")
            ...
            ipPermission.withIpRanges("0.0.0.0/32", "255.255.255.255/32")
            	            .withIpProtocol("tcp")
            	            .withFromPort(22)
            	            .withToPort(22);
           ...
           /* ipPermission.withIpRanges("0.0.0.0/32", "255.255.255.255/32")
            ...
            AuthorizeSecurityGroupIngressRequest authorizeSecurityGroupIngressRequest =
            	...
            	authorizeSecurityGroupIngressRequest.withGroupName("java5")
            ...
            createKeyPairRequest.withKeyName("java5");
            ...
            System.out.println("Created key pair : " + privateKey + "\n");
           // System.out.println(getInstancePublicDnsName)
            ...
            for (Instance ins : resultInstance){
            	...
            	System.out.println("New instance has been created: "+ins.getInstanceId() + " whose ip address is :"+ ins.getPublicIpAddress());
            }
            
//            System.out.println("IP addreess of instance : " + instance.getPublicDnsName());
